...
type TabValue = 'all' | 'isProspect' | 'isReturning';
...
type SortValue = 'updatedAt|desc' | 'updatedAt|asc' | 'totalLoans|desc' | 'totalLoans|asc';
...
const sortOptions: SortOption[] = [
	...
	},
	{
		...
		value: 'totalLoans|desc',
	},
	{
		label: 'Total loans (lowest)',
		value: 'totalLoans|asc',
	},
];
